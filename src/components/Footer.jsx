...
export default function Footer() {
  return (
    <footer className="bg-slate-950 text-slate-300 py-6 md:py-12 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-2 md:px-6 grid grid-cols-4 gap-2 md:gap-12 text-center md:text-left">
        <div>
          <h4 className="text-[9px] md:text-xs font-bold tracking-widest uppercase text-slate-100 mb-2 md:mb-6">COMPANY</h4>
          <ul className="space-y-1 md:space-y-3 text-[9px] md:text-xs tracking-wide">
            <li><Link to="/about-us" className="hover:text-white transition-colors">About Us</Link></li>
          </ul>
        </div>
        <div>
          <h4 className="text-[9px] md:text-xs font-bold tracking-widest uppercase text-slate-100 mb-2 md:mb-6">Services</h4>
          <ul className="space-y-1 md:space-y-3 text-[9px] md:text-xs tracking-wide">
        ...
        <div>
          <h4 className="text-[9px] md:text-xs font-bold tracking-widest uppercase text-slate-100 mb-2 md:mb-6">Projects</h4>
          <ul className="space-y-1 md:space-y-3 text-[9px] md:text-xs tracking-wide">
        ...
        <div>
          <h4 className="text-[9px] md:text-xs font-bold tracking-widest uppercase text-slate-100 mb-2 md:mb-6">Contact</h4>
          <ul className="space-y-1 md:space-y-3 text-[9px] md:text-xs tracking-wide">
