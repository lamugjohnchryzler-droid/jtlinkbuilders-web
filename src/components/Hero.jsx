...
export default function Hero() {
  ...
  const handleScroll = () => {
    ...
    // adding a small offset to ensure it rounds correctly for snapped items
    ...
    <section className="bg-white text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 text-center">
        <motion.h1
          ...
          className="text-3xl md:text-5xl font-semibold leading-tight text-black tracking-tight"
        >
        ...
        <motion.p
          ...
          className="mt-6 text-sm md:text-lg text-slate-600 max-w-3xl mx-auto font-light leading-relaxed px-2"
        >
        ...
        <div className="max-w-7xl mx-auto px-6 pb-20 mt-8">
          <div 
            ...
            className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 sm:grid sm:gap-6 sm:overflow-visible sm:grid-cols-2 md:grid-cols-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
          >
            <div className="snap-center w-[85vw] sm:w-auto flex-shrink-0 group relative overflow-hidden bg-slate-100 col-span-1">
            ...
            <div className="snap-center w-[85vw] sm:w-auto flex-shrink-0 group relative overflow-hidden bg-slate-100 col-span-1 sm:col-span-2 md:col-span-2">
          ...
          <div className="flex sm:hidden justify-center gap-2 mt-4">
            {[0, 1, 2, 3, 4, 5].map((idx) => (
              <div 
                key={idx} 
                className={`w-2 h-2 rounded-full transition-colors duration-300 ${idx === activeIndex ? 'bg-[#001f3f]' : 'bg-slate-300'}`} 
              />
            ))}
          </div>
        </div>
